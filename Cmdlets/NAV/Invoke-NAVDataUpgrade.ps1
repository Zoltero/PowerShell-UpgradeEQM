<#
    .SYNOPSIS
        Invoke the Microsoft Dynamics NAV data upgrade process and wait until it completes. 
	.DESCRIPTION        
		Invoke NAV Data Upgrade process and wait until it completes. 
    	Detected errors are displayed.		
    .PARAMETER ServerInstance
        Specifies the Microsoft Dynamics NAV Server instance that is going to execute the Microsoft Dynamics NAV data upgrade process.
    .PARAMETER SkipAppVersionCheck
        Specifies whether to check the application version of the tenant and application database before starting the data upgrade.

#>

function Invoke-NAVDataUpgrade
{
    param
    (
    ...
    PROCESS
    {
            if($SkipAppVersionCheck.IsPresent)
            {
                Start-NAVDataUpgrade -ServerInstance $ServerInstance -SkipAppVersionCheck -ContinueOnError -Force 
            } 
            else
            {
                Start-NAVDataUpgrade -ServerInstance $ServerInstance -ContinueOnError -Force 
            }
            ...
            $errors = Get-NAVDataUpgrade -ServerInstance $ServerInstance -ErrorOnly
            ...
            Stop-NAVDataUpgrade -ServerInstance $ServerInstance -Force
...
Export-ModuleMember -Function Invoke-NAVDataUpgrade
# SIG # Begin signature block
# MIIkAgYJKoZIhvcNAQcCoIIj8zCCI+8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDchFNKPJZs2Km4
# c3AKOdv8BAPXYc3/CFN4yHpndiA3RqCCDYIwggYAMIID6KADAgECAhMzAAAAww6b
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFmFNEQ/
# nFIEsBKimlwGZMra5/8FHPpaHkUebvTsWywMMFwGCisGAQQBgjcCAQwxTjBMoC6A
# LABNAGkAYwByAG8AcwBvAGYAdAAgAEQAeQBuAGEAbQBpAGMAcwAgAE4AQQBWoRqA
# GGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQBPPBxT
# VCCIegDoVEWIXdozVYfOZIRz7vzt12s/JwMiXy8ZcvPHfv54oY2xNwLJzbR6ERCr
# XZXyNNoYnYuMxMOOeN23k8Vi/4/6DuDJYRLndoQnO6/cUdfUPTpgbK/kEb5XNrsj
# 3LkeyRqIvP/yZV6NEoRAI1c2zgrU1naVdPV2fR+kiiKolSn0CbJxkP4bq7tImomS
# rUvh3Q9lXPEclmtc4jpAlUk/BR8sMRvSLI8118FL09DZWOEgLJ1fxmR0Ub/E38Oi
# ra64yY13zVPb2vIBm/AkKt/wxA/sn+10bjqFtNGk/IhbhJkVSjmIew6zndVzaXdh
# sPF4NQC0NX/nDgAToYITRjCCE0IGCisGAQQBgjcDAwExghMyMIITLgYJKoZIhvcN
# AQcCoIITHzCCExsCAQMxDzANBglghkgBZQMEAgEFADCCATwGCyqGSIb3DQEJEAEE
# oIIBKwSCAScwggEjAgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIOel
# 5eiWoieHjthBpISKTIPnerygslYmROUgYQNnckb7AgZaALlR0zsYEzIwMTcxMTIy
# MjA1NDQwLjMzN1owBwIBAYACAfSggbikgbUwgbIxCzAJBgNVBAYTAlVTMRMwEQYD
# VQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNy
...
# MjAaBgkqhkiG9w0BCQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIJdf
# ndLLS2SMNsADGvq9ONshO4fyRBuOjrpe+lw7yDY2MIHiBgsqhkiG9w0BCRACDDGB
...
# Z9rKQJvL7xWmgYlzGIVyudXa/DANBgkqhkiG9w0BAQsFAASCAQANPt6d/rmlB3vd
# eVyHog6g1AsXjTQuHLSI8lnRzvAbennjinoURQCXjYs65ks3NQ8SD7PXYp3klLLG
# +w3uU9p1q4SYjrb1z+3R1ctD5UUuaWLmvZP+JGNnsfS9Ps1AHVExl+yoHfOQMD+x
# xNYwkyO+v6MNpWJEfRPhcHZSl+N6Yzxwp7bo/buVjXp/k0WlMshq+1QcgtfI5StX
# OO91gE1/fGjbaHpeuhkU7eR6Y8OVCZDa4BLWRf+24UVc2ChWKNC9MY/T/9kdPMJF
# owBGrjK5bbUjZ6r3W84oFmEl/ZwdgFKlq0DKYSLxkpCL4neWQRMPIZq59ddyUbDc
# NNYHs50y
